    ...
    <div className="grid gap-3 rounded-md border border-slate-200 bg-white p-4 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2">
        <form action={deliveredAction}>
          <button
            className="h-9 rounded-md border border-emerald-200 bg-emerald-50 px-3 text-sm font-semibold text-emerald-700 transition hover:bg-emerald-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
        ...
        <form action={cancelAction}>
          <button
            className="h-9 rounded-md border border-red-200 bg-red-50 px-3 text-sm font-semibold text-red-700 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400"
